...
<nav class="navbar navbar-light navbar-expand-md my-auto"
    ...
    <form:form action="${pageContext.request.contextPath}/logout" method="POST">
        ...
        <div class="container-fluid">
                        ...
                        <div style="width: 1080px;transform: translate(288px) translateY(-115px);height: 1368px;padding: 0;margin-top: 24px;">
                            <div style="transform: translateX(-45px) translateY(-35px);width: 1080;height: 10px;">
                                <h1 class="d-flex flex-grow-1"
                                    style="font-size: 14px;width: 1080px;color: rgb(86,86,86);transform: translateX(0px) translateY(-23px);border: 0px none var(--bs-body-bg);border-bottom: 1px solid rgb(72,72,72);padding-left: 22px;margin-bottom: 0;margin-top: 0;padding-top: 0px;padding-bottom: 9px;">
                                    IDI Spec Sheet</h1>
                            </div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6" style="padding-top:40px;width: 324px;">
                                        <div style="width: 763px;height: 42px;margin-bottom: 0px;padding-bottom: 0px;">
                                            <h1 class="d-flex flex-grow-1"
                                                style="font-size: 28px;width: 938px;margin-bottom: 24px;">Home</h1>
                                            <div style="width: 990px;margin-left: 23px;margin-top: 40px;">
                                                <div class="row">
                                                    <div id="tableBorder" class="tableBorder"
                                                         style="height: 350px;padding-right: 16px;padding-left: 16px;border-radius: 8px;border: 1px solid rgba(122,122,122,0.71);">
                                                        <div class="card"
                                                            ...
                                                            <div style="padding: 4px;margin: 0px;padding-top: 24px;">
                                                                <div class="table-responsive">
                                                                    <table class="table" id="projTbl">
                                                                        ...
                                                                        <c:forEach items="${projects}" var="project">
                                                                            ...
                                                                            <tr>
                                                                                <td><span><label
                                                                                        style="padding:8px;width:400px;">${project.pName}</label></span>
                                                                                </td>
                                                                                <td><span><label
                                                                                        style="padding:8px;width:100px;">${project.id}</label></span>
                                                                                </td>
                                                                                <td>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col"><a class="btn btn-primary"
                                                                                        role="button" id="newProject"
                                                                                        style="background: rgb(20,62,125);padding-top:6px;margin-top: 16px;font-size: 13px;height: 36px;width: 144px;"
                                                                                        href="showInfo">Create New
                                                                        Project</a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col bounce animated">
                                                        <div class="alert alert-success invisible bounce animated beautiful"
                                                             role="alert"><Strong>Success!</Strong> Created app
                                                            successfully.
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <input class="btn btn-primary" value="Log Out" type="submit" id="signOut"
                   style="transform: translateX(32px) translateY(88px);height:36px;width: 106px;min-width: 140px;background: rgb(132,8,0);"/>
        </div>
        </div>
    </form:form>
</nav>
